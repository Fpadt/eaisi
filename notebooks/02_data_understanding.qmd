...
The ABC/XYZ classification is a two-dimensional analysis that helps prioritize items based on their importance and predictability.  
...
The Syntetos-Boylan (SB) classification is a method to categorize demand patterns based on their statistical properties, particularly focusing on the Average Demand Interval (ADI) and Coefficient of Variation (CV).
