...
<!-- White Paper: The Heart of Pythia -->
...
# The Heart of Pythia {#sec-00-the-heart-of-pythia}

## Introduction 

<!-- A very brief orient-in: what this analysis covers, why we chose CRISP-DM, and a roadmap of the sections to follow. -->
...
<!--    A paragraph or two on why CRISP-DM and how you’ve tailored it.   -->
<!-- – **2.2 Scope & Objectives**   -->
<!--    Restate the business question(s) and success criteria. -->
...
<!-- – Detailed statement of the problem, KPIs, constraints, stakeholders. -->
