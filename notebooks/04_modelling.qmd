...
### Interpretability vs. Flexibility Tradeoff {#sec-04-tradeoff}

The choice of modelling technique often involves a tradeoff between flexibility and interpretability. More flexible models, such as deep learning, can capture complex patterns but at the cost of reduced interpretability. Conversely, simpler statistical models are easier to understand but may not perform as well on complex datasets.
