...
Instead, the focus is on **ambient** products having a minimum shelf life of 
60 days, which follow a weekly MRP cycle and are forecasted in **monthly** time 
buckets. These products represent the bulk of *BioBalance’s* volume and are 
most aligned with the strategic forecasting use cases discussed in this study.
...
*BioBalance* uses a third-party system employing traditional statistical models. For each foecast to make Planners:

1.  Prepare data,
2.  Select one of five predefined aggregation levels. 
3.  Fine-tune parameters
4.  Simulate results
5.  Adjust or override forecasts manually.
6.  Distribute the forecast Top-Down.
