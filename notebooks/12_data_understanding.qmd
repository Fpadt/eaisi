...
# Data Understanding {#sec-12-data-understanding}
...
Table @tbl-12-data-description-meta gives all details of the datasets,
...
Table @tbl-12-data-profiling-ca shows the data profiling results for the dataset,
...
::: {#tbl-12-data-profiling-ca .table}
```{r}
dtACC_sk[
  type == 'character', .(
    variable, 
...
Table @tbl-12-data-profiling-nu shows the data profiling results for the 
...
::: {#tbl-12-data-profiling-nu  .table}
```{r}
dtACC_sk[
  type == 'numeric', .(
    variable, 
...
Table @tbl-12-data-description-hierarchy-article summarizes the 4-levels of the article hierarchy by a unique count per level. Roughly,
...
::: {#tbl-12-data-description-hierarchy-article}  
```{r}
...
Table @tbl-12-data-description-hierarchy-customer summarizes the 4-levels of the 
...
::: {#tbl-12-data-description-hierarchy-customer  .table}
```{r}
...
## Summary of Data Understanding {#sec-12-summary}
