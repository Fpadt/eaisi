...
#### Cross-References
This book contains cross-references to figures (@fig-bu-why), definitions (@def-RSME), 
and sections ([Research Analysis](nb/00_pythias_advice_rev.html)).
Hovering over the link will give a sneak peek of the content.
...
The [Research Analysis](nb/00_pythias_advice_rev.html) section is designed to be read in a linear fashion and follows the CRISP-DM phases. 

Details on each phase with related coding can
be found in the appendix, each phase has it's own page, e.g. [Business Understanding](nb/01_business_understanding_rev.html)
