...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, opacityback=0, rightrule=.15mm, titlerule=0mm, coltitle=black, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, opacityback=0, rightrule=.15mm, titlerule=0mm, coltitle=black, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]

This is an example of a callout with a title.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, opacityback=0, rightrule=.15mm, titlerule=0mm, coltitle=black, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Expand To Learn About Collapse}, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
