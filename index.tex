...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, arc=.35mm, breakable, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, arc=.35mm, breakable, colback=white, colframe=quarto-callout-tip-color-frame, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}, rightrule=.15mm, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6]

This is an example of a callout with a title.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, arc=.35mm, breakable, colback=white, colframe=quarto-callout-caution-color-frame, opacityback=0, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Expand To Learn About Collapse}, rightrule=.15mm, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6]
...
\NormalTok{mtcars[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{] }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gt}\NormalTok{(}\AttributeTok{rowname\_col =} \StringTok{"model"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{tab\_header}\NormalTok{(}
    \AttributeTok{title =} \FunctionTok{md}\NormalTok{(}\StringTok{"**First 6 Cars**"}\NormalTok{),}
    \AttributeTok{subtitle =} \StringTok{"A small gt demo"}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{data\_color}\NormalTok{(}
    \AttributeTok{columns =} \FunctionTok{vars}\NormalTok{(mpg, hp),}
    \AttributeTok{colors =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{col\_numeric}\NormalTok{(}
      \AttributeTok{palette =} \FunctionTok{c}\NormalTok{(}\StringTok{"lightblue"}\NormalTok{, }\StringTok{"navy"}\NormalTok{),}
...
\begin{table}
\caption*{
{\large \textbf{First 6 Cars}} \\ 
{\small A small gt demo}
} 
...
{\cellcolor[HTML]{5B54A7}{\textcolor[HTML]{FFFFFF}{21.0}}} & 6 & 160 & {\cellcolor[HTML]{93AAD1}{\textcolor[HTML]{000000}{110}}} & 3.90 & 2.620 \\ 
{\cellcolor[HTML]{5B54A7}{\textcolor[HTML]{FFFFFF}{21.0}}} & 6 & 160 & {\cellcolor[HTML]{93AAD1}{\textcolor[HTML]{000000}{110}}} & 3.90 & 2.875 \\ 
{\cellcolor[HTML]{000080}{\textcolor[HTML]{FFFFFF}{22.8}}} & 4 & 108 & {\cellcolor[HTML]{ADD8E6}{\textcolor[HTML]{000000}{93}}} & 3.85 & 2.320 \\ 
{\cellcolor[HTML]{4E429F}{\textcolor[HTML]{FFFFFF}{21.4}}} & 6 & 258 & {\cellcolor[HTML]{93AAD1}{\textcolor[HTML]{000000}{110}}} & 3.08 & 3.215 \\ 
{\cellcolor[HTML]{9DBBD9}{\textcolor[HTML]{000000}{18.7}}} & 8 & 360 & {\cellcolor[HTML]{000080}{\textcolor[HTML]{FFFFFF}{175}}} & 3.15 & 3.440 \\ 
{\cellcolor[HTML]{ADD8E6}{\textcolor[HTML]{000000}{18.1}}} & 6 & 225 & {\cellcolor[HTML]{9BB7D7}{\textcolor[HTML]{000000}{105}}} & 2.76 & 3.460 \\ 
\bottomrule
\end{tabular*}
\end{table}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{8}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{gt}\NormalTok{(}\AttributeTok{rowname\_col =} \StringTok{"model"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{tab\_header}\NormalTok{(}
    \AttributeTok{title    =} \FunctionTok{md}\NormalTok{(}\StringTok{"**My Branded Table**"}\NormalTok{),}
    \AttributeTok{subtitle =} \StringTok{"With a consistent gt theme"}
\NormalTok{  ) }
\end{Highlighting}
\end{Shaded}
...
\begin{table}
\caption*{
{\large \textbf{My Branded Table}} \\ 
{\small With a consistent gt theme}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}rrrrrr}
\toprule
