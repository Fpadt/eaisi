...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, coltitle=black, opacityback=0, toprule=.15mm, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, colback=white, coltitle=black, opacityback=0, toprule=.15mm, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}]

This is an example of a callout with a title.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, left=2mm, colframe=quarto-callout-caution-color-frame, colback=white, coltitle=black, opacityback=0, toprule=.15mm, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-caution-color!10!white, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Expand To Learn About Collapse}]
