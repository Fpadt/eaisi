...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, colback=white, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, left=2mm, breakable, opacitybacktitle=0.6, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, colback=white, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, breakable, opacitybacktitle=0.6, toprule=.15mm, opacityback=0]

This is an example of a callout with a title.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, colback=white, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Expand To Learn About Collapse}, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, breakable, opacitybacktitle=0.6, toprule=.15mm, opacityback=0]
...
\begin{table}
\caption*{
{\large Shipments by Origin → Destination} \\ 
{\small Metrics grouped by origin using GT row groups}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 90.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
 & \multicolumn{6}{>{\centering\arraybackslash}m{\dimexpr 390.00pt -2\tabcolsep-1.5\arrayrulewidth}}{TO} \\ 
\cmidrule(lr){2-7}
Metric & BE & DE & FR & GB & IT & NL \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries 3P}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & 2 & 8 & 13 & 7 & 5 & 11 \\ 
{\itshape Average Items} & 14.0 & 18.9 & 97.1 & 17.9 & 10.6 & 18.7 \\ 
{\itshape Max Items} & {\bfseries 19} & {\bfseries 77} & {\bfseries 402} & {\bfseries 44} & {\bfseries 20} & {\bfseries 52} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries DE}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & NA & 4 & 3 & 2 & 2 & 3 \\ 
{\itshape Average Items} & NA & 58.5 & 21.0 & 4.5 & 3.5 & 17.3 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries 135} & {\bfseries 32} & {\bfseries 7} & {\bfseries 5} & {\bfseries 32} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries ES}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & NA & NA & 3 & NA & 2 & NA \\ 
{\itshape Average Items} & NA & NA & 2.3 & NA & 5.5 & NA \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 5} & {\bfseries NA} & {\bfseries 6} & {\bfseries NA} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries FR}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & NA & NA & 1 & 1 & NA & 1 \\ 
{\itshape Average Items} & NA & NA & 152.0 & 4.0 & NA & 10.0 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 152} & {\bfseries 4} & {\bfseries NA} & {\bfseries 10} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries GB}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & NA & 1 & 1 & 1 & 2 & 2 \\ 
{\itshape Average Items} & NA & 61.0 & 84.0 & 163.0 & 23.5 & 85.5 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries 61} & {\bfseries 84} & {\bfseries 163} & {\bfseries 45} & {\bfseries 168} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{510pt}}{{\bfseries IT}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Count (n)} & 1 & 1 & 1 & 1 & 1 & 1 \\ 
{\itshape Average Items} & 1.0 & 22.0 & 155.0 & 3.0 & 194.0 & 25.0 \\ 
{\itshape Max Items} & {\bfseries 1} & {\bfseries 22} & {\bfseries 155} & {\bfseries 3} & {\bfseries 194} & {\bfseries 25} \\ 
\bottomrule
\end{tabular*}
\end{table}
...
\caption*{
{\large Shipments by Origin → Destination} \\ 
{\small Manual row grouping with pure data.table syntax}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 90.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
 & \multicolumn{6}{>{\centering\arraybackslash}m{\dimexpr 360.00pt -2\tabcolsep-1.5\arrayrulewidth}}{TO} \\ 
\cmidrule(lr){2-7}
Metric & BE & DE & FR & GB & IT & NL \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{IT}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & 1.0 & 22.0 & 155.0 & 3.0 & 194.0 & 25.0 \\ 
{\itshape Count (n)} & 1 & 1 & 1 & 1 & 1 & 1 \\ 
{\itshape Max Items} & {\bfseries 1} & {\bfseries 22} & {\bfseries 155} & {\bfseries 3} & {\bfseries 194} & {\bfseries 25} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{GB}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & NA & 61.0 & 84.0 & 163.0 & 23.5 & 85.5 \\ 
{\itshape Count (n)} & NA & 1 & 1 & 1 & 2 & 2 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries 61} & {\bfseries 84} & {\bfseries 163} & {\bfseries 45} & {\bfseries 168} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{FR}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & NA & NA & 152.0 & 4.0 & NA & 10.0 \\ 
{\itshape Count (n)} & NA & NA & 1 & 1 & NA & 1 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 152} & {\bfseries 4} & {\bfseries NA} & {\bfseries 10} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{ES}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & NA & NA & 2.3 & NA & 5.5 & NA \\ 
{\itshape Count (n)} & NA & NA & 3 & NA & 2 & NA \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 5} & {\bfseries NA} & {\bfseries 6} & {\bfseries NA} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{DE}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & NA & 58.5 & 21.0 & 4.5 & 3.5 & 17.3 \\ 
{\itshape Count (n)} & NA & 4 & 3 & 2 & 2 & 3 \\ 
{\itshape Max Items} & {\bfseries NA} & {\bfseries 135} & {\bfseries 32} & {\bfseries 7} & {\bfseries 5} & {\bfseries 32} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{7}{>{\raggedright\arraybackslash}m{450pt}}{{\bfseries \cellcolor[HTML]{F8F9FA}{3P}}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
{\itshape Average Items} & 14.0 & 18.9 & 97.1 & 17.9 & 10.6 & 18.7 \\ 
{\itshape Count (n)} & 2 & 8 & 13 & 7 & 5 & 11 \\ 
{\itshape Max Items} & {\bfseries 19} & {\bfseries 77} & {\bfseries 402} & {\bfseries 44} & {\bfseries 20} & {\bfseries 52} \\ 
...
\caption*{
{\large Shipments by Origin → Destination} \\ 
{\small Origin grouping displayed in left column}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 90.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
 &  & \multicolumn{6}{>{\centering\arraybackslash}m{\dimexpr 360.00pt -2\tabcolsep-1.5\arrayrulewidth}}{TO} \\ 
\cmidrule(lr){3-8}
FROM & Metric & BE & DE & FR & GB & IT & NL \\ 
\midrule\addlinespace[2.5pt]
{\bfseries 3P} & {\itshape Average Items} & 14.0 & 18.9 & 97.1 & 17.9 & 10.6 & 18.7 \\ 
{} & {\itshape Count (n)} & 2 & 8 & 13 & 7 & 5 & 11 \\ 
{} & {\itshape Max Items} & {\bfseries 19} & {\bfseries 77} & {\bfseries 402} & {\bfseries 44} & {\bfseries 20} & {\bfseries 52} \\ 
{\bfseries DE} & {\itshape Average Items} & NA & 58.5 & 21.0 & 4.5 & 3.5 & 17.3 \\ 
{} & {\itshape Count (n)} & NA & 4 & 3 & 2 & 2 & 3 \\ 
{} & {\itshape Max Items} & {\bfseries NA} & {\bfseries 135} & {\bfseries 32} & {\bfseries 7} & {\bfseries 5} & {\bfseries 32} \\ 
{\bfseries ES} & {\itshape Average Items} & NA & NA & 2.3 & NA & 5.5 & NA \\ 
{} & {\itshape Count (n)} & NA & NA & 3 & NA & 2 & NA \\ 
{} & {\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 5} & {\bfseries NA} & {\bfseries 6} & {\bfseries NA} \\ 
{\bfseries FR} & {\itshape Average Items} & NA & NA & 152.0 & 4.0 & NA & 10.0 \\ 
{} & {\itshape Count (n)} & NA & NA & 1 & 1 & NA & 1 \\ 
{} & {\itshape Max Items} & {\bfseries NA} & {\bfseries NA} & {\bfseries 152} & {\bfseries 4} & {\bfseries NA} & {\bfseries 10} \\ 
{\bfseries GB} & {\itshape Average Items} & NA & 61.0 & 84.0 & 163.0 & 23.5 & 85.5 \\ 
{} & {\itshape Count (n)} & NA & 1 & 1 & 1 & 2 & 2 \\ 
{} & {\itshape Max Items} & {\bfseries NA} & {\bfseries 61} & {\bfseries 84} & {\bfseries 163} & {\bfseries 45} & {\bfseries 168} \\ 
{\bfseries IT} & {\itshape Average Items} & 1.0 & 22.0 & 155.0 & 3.0 & 194.0 & 25.0 \\ 
{} & {\itshape Count (n)} & 1 & 1 & 1 & 1 & 1 & 1 \\ 
{} & {\itshape Max Items} & {\bfseries 1} & {\bfseries 22} & {\bfseries 155} & {\bfseries 3} & {\bfseries 194} & {\bfseries 25} \\ 
\bottomrule
\end{tabular*}
...
\subsection{hybrid grouping}\label{hybrid-grouping}

\begin{table}
\caption*{
{\large Shipments by Origin → Destination} \\ 
{\small Enhanced left-column grouping with visual indicators}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 90.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 60.00pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
 &  & \multicolumn{6}{>{\centering\arraybackslash}m{\dimexpr 360.00pt -2\tabcolsep-1.5\arrayrulewidth}}{TO} \\ 
\cmidrule(lr){3-8}
FROM & Metric & BE & DE & FR & GB & IT & NL \\ 
\midrule\addlinespace[2.5pt]
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{3P}}} & Average Items & {\bfseries 14.0} & {\bfseries 18.9} & {\bfseries 97.1} & {\bfseries 17.9} & {\bfseries 10.6} & {\bfseries 18.7} \\ 
{} & {Count (n)} & {2} & {8} & {13} & {7} & {5} & {11} \\ 
{} & {Max Items} & {19} & {77} & {402} & {44} & {20} & {52} \\ 
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{DE}}} & Average Items & {\bfseries NA} & {\bfseries 58.5} & {\bfseries 21.0} & {\bfseries 4.5} & {\bfseries 3.5} & {\bfseries 17.3} \\ 
{} & {Count (n)} & {NA} & {4} & {3} & {2} & {2} & {3} \\ 
{} & {Max Items} & {NA} & {135} & {32} & {7} & {5} & {32} \\ 
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{ES}}} & Average Items & {\bfseries NA} & {\bfseries NA} & {\bfseries 2.3} & {\bfseries NA} & {\bfseries 5.5} & {\bfseries NA} \\ 
{} & {Count (n)} & {NA} & {NA} & {3} & {NA} & {2} & {NA} \\ 
{} & {Max Items} & {NA} & {NA} & {5} & {NA} & {6} & {NA} \\ 
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{FR}}} & Average Items & {\bfseries NA} & {\bfseries NA} & {\bfseries 152.0} & {\bfseries 4.0} & {\bfseries NA} & {\bfseries 10.0} \\ 
{} & {Count (n)} & {NA} & {NA} & {1} & {1} & {NA} & {1} \\ 
{} & {Max Items} & {NA} & {NA} & {152} & {4} & {NA} & {10} \\ 
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{GB}}} & Average Items & {\bfseries NA} & {\bfseries 61.0} & {\bfseries 84.0} & {\bfseries 163.0} & {\bfseries 23.5} & {\bfseries 85.5} \\ 
{} & {Count (n)} & {NA} & {1} & {1} & {1} & {2} & {2} \\ 
{} & {Max Items} & {NA} & {61} & {84} & {163} & {45} & {168} \\ 
{\bfseries \cellcolor[HTML]{ECF0F1}{\textcolor[HTML]{2C3E50}{IT}}} & Average Items & {\bfseries 1.0} & {\bfseries 22.0} & {\bfseries 155.0} & {\bfseries 3.0} & {\bfseries 194.0} & {\bfseries 25.0} \\ 
{} & {Count (n)} & {1} & {1} & {1} & {1} & {1} & {1} \\ 
{} & {Max Items} & {1} & {22} & {155} & {3} & {194} & {25} \\ 
\bottomrule
\end{tabular*}
\end{table}

\chapter{GGPlots}\label{ggplots}

ggplot and spark

\begin{table}
\caption*{
{\large Lead Time Analysis by Category} \\ 
{\small Sparkline distributions with performance indicators}
} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 75.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 52.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 90.00pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
Category & Count & Mean & Median & Std Dev & Min & Max & 95th \%ile & Distribution \\ 
\midrule\addlinespace[2.5pt]
Non category specific & 4 & 3.0 & 3.5 & 1.4 & 1.0 & 4.0 & 4.0 & {\bfseries ▃        ▃    ▇ ●} \\ 
Functional Foods & 5 & 7.4 & 5.0 & 8.4 & 1.0 & 22.0 & 18.8 & {\bfseries ▃▃▇       ▃ ●} \\ 
Others & 5 & 10.4 & 13.0 & 7.1 & 1.0 & 17.0 & 16.8 & {\bfseries ▇  ▇       ▇  ▇▇ ◐} \\ 
Breakfast Cereals & 10 & 15.1 & 4.5 & 17.2 & 1.0 & 45.0 & 42.3 & {\bfseries ▇         ◑} \\ 
Bread and Biscuit Alternatives & 5 & 19.4 & 19.0 & 13.2 & 2.0 & 35.0 & 33.8 & {\bfseries ▇   ▇   ▇    ▇  ▇ ○} \\ 
Sweet Spreads, Purees, Sweeteners & 7 & 24.9 & 16.0 & 40.3 & 2.0 & 115.0 & 85.6 & {\bfseries ▇▇         ▂ ○} \\ 
Bread and Bakery & 1 & 30.0 & 30.0 & NA & 30.0 & 30.0 & 30.0 & {\bfseries ▇ ○} \\ 
Juices and Cold Drinks & 3 & 36.3 & 34.0 & 27.6 & 10.0 & 65.0 & 61.9 & {\bfseries ▇   ▇     ▇ ○} \\ 
Sweets in Between & 8 & 52.8 & 27.0 & 87.8 & 2.0 & 267.0 & 188.9 & {\bfseries ▇▇▂          ▂ ○} \\ 
Dairy Alternatives & 10 & 53.8 & 21.0 & 70.2 & 1.0 & 194.0 & 176.4 & {\bfseries ▇▂  ▁  ▁ ▁ ○} \\ 
Hot Drinks & 13 & 64.8 & 51.0 & 59.4 & 4.0 & 168.0 & 165.0 & {\bfseries ▄▇  ▂▄▂ ▂      ▂▄ ○} \\ 
Meals and Meal components & 9 & 79.1 & 22.0 & 128.3 & 1.0 & 402.0 & 295.2 & {\bfseries ▇         ○} \\ 
Animal based products & 1 & 123.0 & 123.0 & NA & 123.0 & 123.0 & 123.0 & {\bfseries ▇ ○} \\ 
\bottomrule
\end{tabular*}
\end{table}
...
\chapter{flextable}\label{flextable}
...
\begin{longtable*}[c]{|p{2.78in}|p{0.73in}|p{0.68in}|p{2.29in}}



\ascline{1.5pt}{666666}{1-4}

\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textbf{Category}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textbf{Count}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textbf{Mean}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textbf{Distribution}}}}} \\
...
\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Bread\ and\ Biscuit\ Alternatives}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{5}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{19.4}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-1.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Dairy\ Alternatives}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{10}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{53.8}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-2.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Sweets\ in\ Between}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{8}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{52.8}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-3.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Others}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{5}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{10.4}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-4.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Meals\ and\ Meal\ components}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{9}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{79.1}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-5.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Sweet\ Spreads,\ Purees,\ Sweeteners}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{7}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{24.9}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-6.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Breakfast\ Cereals}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{10}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{15.1}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-7.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Functional\ Foods}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{5}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{7.4}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-8.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Hot\ Drinks}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{13}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{64.8}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-9.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Bread\ and\ Bakery}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{1}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{30.0}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-10.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Juices\ and\ Cold\ Drinks}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{3}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{36.3}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-11.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Animal\ based\ products}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{1}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{123.0}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-12.png}} \\

\ascline{0.75pt}{666666}{1-4}



\multicolumn{1}{>{\raggedright}m{\dimexpr 2.78in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Non\ category\ specific}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.73in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{4}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.68in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{3.0}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 2.29in+0\tabcolsep}}{\includegraphics[width=2in, height=1in]{01_business_understanding_rev_files/figure-pdf/flextable-13.png}} \\
...
\chapter{Data Preparation}\label{data-preparation-2}

preparing the data for further analysis and modeling. This might involve
cleaning and pre-processing the data, as well as transforming it into a
