...
The ABC/XYZ classification is a widely used method to prioritize items based 
on their importance and predictability. It helps in determining which items 
should be forecasted and how tightly they should be controlled.
...
- AX: High-priority & stable items (AX), forecast carefully.

- AZ: High-priority & erratic items (AZ), forecast with caution.
...
The Syntetos-Boylan (SB) classification is an extension of the ABC/XYZ classification,
which combines the concepts of demand variability and forecastability. 
It helps in identifying the nature of demand patterns and selecting 
appropriate forecasting methods.

The time Series *BioBalance* are for a large part intermittent & smooth, depending
...
SB-Classification for each aggregation level
:::
