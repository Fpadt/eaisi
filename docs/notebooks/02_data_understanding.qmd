...
A detailed overview of all dataset fields, including names, data types, key flags, conversion routines, and hierarchy levels, is provided in the appendix.

See @tbl-12-data-description for the full variable catalog.
...
```
sample of overview of all data set fields, see @tbl-12-data-description for the full variable catalog.
:::
