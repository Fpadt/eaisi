...
```
>>>>>>> 2c8b9d29c6a55ca72235490103349d3dc6262d9f
...
## Who uses the forecasts? {#sec-11-bu-who}
<!-- stakeholders. -->
...
::: callout-important
Some goods-flow use a Sales/order purcchase order flow for intercompany sales. 
...
-   **RMSE (Root Mean Squared Error, @def-11-RMSE )**: The primary metric for measuring forecast accuracy, particularly useful for penalizing large errors.
