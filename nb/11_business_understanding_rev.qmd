...
group is available in Appendix [@sec-appendix-usecases]:
...
## traditional statistical forecasting methods {#tab-forecasting-methods}

| Method | Description |
|:-------|:------------|
| **Moving Average** | Averages past observations to smooth out short-term fluctuations. |
| **Exponential Smoothing** | Applies decreasing weights to past observations, emphasizing more recent data. |
