...
Key components: - **Repositories** (hosted on GitHub): - [EAISI-PAPER](https://github.com/Fpadt/eaisi): Project documentation and analysis - [EAISI-PYTHIA](https://github.com/Fpadt/EAISI-Pythia): Core modeling workflows - [EAISI-PADT](https://github.com/Fpadt/EAISI-Padt): **P**ythia's **A**dvice - **D**ata **T**ooling, see Appendix @sec-package-padt, for details and documentation.
