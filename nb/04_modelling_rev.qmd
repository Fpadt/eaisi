...
<video src="../video/glass_blackbox.mp4" controls autoplay muted loop width="320" playsinline>
</video>
:::
...
This project is implemented in R using an open-source, local-first setup. 
Modeling and analysis are developed in RStudio and documented using Quarto.
